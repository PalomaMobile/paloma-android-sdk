...
/**
 * Overrides {@link #onTokenRefresh()} to add a new {@link JobPostUserGcmRegistrationIdUpdate} to the job queue as returned by {@link ServiceSupport#getJobManager()}.
...
public class NotificationInstanceIDListenerService extends InstanceIDListenerService {
    ...
    /**
     * Add a new {@link JobPostUserGcmRegistrationIdUpdate} to the job queue as returned by {@link ServiceSupport#getJobManager()}.
     * This has the effect of keeping the Gcm registration id on client and server in sync.
     */
    @Override
