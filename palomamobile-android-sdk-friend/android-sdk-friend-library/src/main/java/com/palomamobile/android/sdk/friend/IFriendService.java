...
public interface IFriendService {
    ...
    PaginatedResponse<Friend> getFriends(@Path("userId") long userId, @QueryMap Map<String, String> options);
    ...
    Void postSocialUserCredentials(@Path("userId") long userId, @Body SocialUserCredential credential, @QueryMap Map<String, String> options);
    ...
    Relationship putRelationship(@Path("userId") long userId, @Path("reciprocalUserId") long reciprocalUserId, @Body RelationAttributes relationAttributes);
    ...
    PaginatedResponse<Relationship> getRelationships(@Path("userId") long userId, @QueryMap Map<String, String> options);
