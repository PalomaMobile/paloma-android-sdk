...
/**
 * Convenience wrapper around {@link IFriendService#putRelationship(long, long, RelationAttributes)}
...
public class JobPutRelationship extends BaseRetryPolicyAwareJob<Relationship> {
    ...
    public Relationship syncRun(boolean postEvent) throws Throwable {
        ...
        Relationship result = friendManager.getService().putRelationship(user.getId(), reciprocalUserId, relationAttributes);
